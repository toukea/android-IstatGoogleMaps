...
public class GmapZoomer {
    ...
    private static String EXTRA_WAIT = "wait", EXTRA_ZOOM = "zoom",
            EXTRA_TIME = "time", EXTRA_LAT = "lat", EXTRA_LGNT = "lgt";
    protected Handler ZoomerHandler = new Handler() {
            ...
            handler = new Handler() {
                ...
                public void handleMessage(Message msg) {
                    try {
                        ...
                        bundle.putDouble(EXTRA_LGNT, point.longitude);
                        bundle.putDouble(EXTRA_TIME, zoomTime);
                        Message message = new Message();
                        message.setData(bundle);
                        ZoomerHandler.sendMessage(message);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
